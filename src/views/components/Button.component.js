...
import ClickableComponent from "./ui/Clickable.component.js";
...
export default class ButtonComponent extends BaseUIComponent {
    ...
    _setupComponents(x, y, width, height, text, onClick) {
        this.addComponent(COMPONENTS_ID.TransformModel, new TransformModel(x, y, width, height))
        this.addComponent(COMPONENTS_ID.RendererUI, new RendererUIComponent(`${ASSETS_PATH.Components}/main-menu-button-${text}.png`))
